...
logMemoryPath = str(param)       #logMemoryPath '/home/bn10513137/evaPoolPath/logOneAggreMemory.txt'
# 開啟文件並讀取數據
...
#logMemoryPath '/home/bn10513137/evaPoolPath/logOneAggreMemory.txt'

splitPathtxt      = logMemoryPath.split("/")       # 使用 "/" 進行分割

splitPathtxt[-1]  = "Sum" + splitPathtxt[-1]       # 在最後一個子字串前面加上 "Sum"

SumlogMemoryPath  = "/".join(splitPathtxt)         # 重新連接字串    --- #SumlogMemoryPath '/home/bn10513137/evaPoolPath/SumlogOneAggreMemory.txt'
...
# 每 OneAggre Memory 獲得一個平均值 ， 並將所有獲得之平均值，除以聚合的次數，獲得實驗結果
...
# CSV檔案路徑和名稱
# SumlogMemoryPathcsv = "/home/bn10513137/evaPoolPath/logOneAggreMemory.csv"
