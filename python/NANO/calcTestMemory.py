...
logMemoryPath = str(param)       #logMemoryPath '/home/bn10513137/evaPoolPath/logTestMemory.txt'
# 開啟文件並讀取數據
...
#logMemoryPath '/home/bn10513137/evaPoolPath/logTestMemory.txt'

splitPathtxt      = logMemoryPath.split("/")       # 使用 "/" 進行分割

splitPathtxt[-1]  = "Sum" + splitPathtxt[-1]       # 在最後一個子字串前面加上 "Sum"

SumlogMemoryPath  = "/".join(splitPathtxt)         # 重新連接字串    --- #SumlogMemoryPath '/home/bn10513137/evaPoolPath/SumlogTestMemory.txt'
...
# CSV檔案路徑和名稱
# SumlogMemoryPathcsv = "/home/bn10513137/evaPoolPath/logTestMemory.csv"
