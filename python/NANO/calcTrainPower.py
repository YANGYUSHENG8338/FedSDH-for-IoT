...
logPowerPath = str(param)             #logPowerPath '/home/bn10513137/evaPoolPath/logTrainPower.txt'
...
SumlogPowerPath  = "/".join(splitPathtxt)        # 重新連接字串    --- #SumlogPowerPath '/home/bn10513137/evaPoolPath/SumlogTrainPower.txt'
...
# 每輪 Train Power 都將獲得一個平均值 ， 並將所有獲得之平均值，除以聚合的次數，獲得實驗結果
# print(result)
...
# CSV檔案路徑和名稱
# SumlogPowerPathcsv = "/home/bn10513137/evaPoolPath/logTrainPower.csv"
