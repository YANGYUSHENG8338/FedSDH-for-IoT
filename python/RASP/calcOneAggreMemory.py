...
logMemoryPath = str(param)       #logMemoryPath '/home/raspdslab/evaPoolPath/logOneAggreMemory.txt'
# 開啟文件並讀取數據
...
#logMemoryPath '/home/raspdslab/evaPoolPath/logOneAggreMemory.txt'

splitPathtxt      = logMemoryPath.split("/")       # 使用 "/" 進行分割

splitPathtxt[-1]  = "Sum" + splitPathtxt[-1]       # 在最後一個子字串前面加上 "Sum"

SumlogMemoryPath  = "/".join(splitPathtxt)         # 重新連接字串    --- #SumlogMemoryPath '/home/raspdslab/evaPoolPath/SumlogOneAggreMemory.txt'
...
# CSV檔案路徑和名稱
# SumlogMemoryPathcsv = "/home/raspdslab/evaPoolPath/logOneAggreMemory.csv"
